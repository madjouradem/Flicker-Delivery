...
import 'package:delivery_app/core/functions/showAlert.dart';
import 'package:delivery_app/pages/auth/Login/loginData.dart';
    ...
    if (formstate.currentState!.validate()) {
      ...
      if (StatusRequest.success == statusRequest) {
        if (response['status'] == "success") {
          ...
          myServices.box.write("delivery", response['data']);
